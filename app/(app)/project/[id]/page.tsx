    ...
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      ...
      <Tabs defaultValue="overview">
        ...
        <TabsContent value="changes" className="mt-6">
          <div className="rounded-xl border border-dashed border-zinc-200 bg-zinc-50 p-12 text-center">
            <p className="font-medium text-zinc-700">BRD change history</p>
            <p className="mt-1 text-sm text-zinc-500">
              Re-upload a BRD to detect what changed and regenerate only the affected sections.
            </p>
            <Link
              href={`/project/${project.id}/changes`}
